...
seeding_cases <- 10
matrix_primary<- "./data/UMIC_coverage_primary.csv"
matrix_d3 <-  "./data/UMIC_coverage_primary.csv"
...
# Run
runs4 <- run$enqueue_bulk(scenarios, run_scenario, do_call = TRUE, progress = TRUE)
runs4$status()
