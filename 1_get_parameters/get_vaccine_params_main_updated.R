...
name <- "UKHSA_v6pn_65+_20220702_AZPD2=FALSE_SB=FALSE_NewDecay=TRUE_AddBst=FALSE_AltSev=FALSE_mcmc_chain"
...
load(paste0("0_antibody_model_fitting/Model Fits/", name, ".Rdata"))
