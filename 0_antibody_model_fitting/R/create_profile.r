...
draw <-
  ...
  nt <- rep(0, length(t))
  nt[1:length(t)] <- mu_ab_d4 + cum_dr_vec[1:length(t)]
...
#  nt[(t_d2+t_d3+2):(t_d2+t_d3+t_d4)] <-  nt[t_d2+t_d3+1] + cum_dr_vec[2:t_d4]
#  nt[t_d2+t_d3+t_d4+1] <- mu_ab_d4
#  nt[(t_d2+t_d3+t_d4+2):length(t)] <-  nt[t_d2+t_d3+t_d4+1] + cum_dr_vec[2:(length(t)-(t_d2+t_d3+t_d4))]
